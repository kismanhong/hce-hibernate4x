...
public class PropertyBetweenExpression implements Criterion {
    ...
    public PropertyBetweenExpression(String propertyName, String lo, String hi) {
    ...
    public String toSqlString(Criteria criteria, CriteriaQuery criteriaQuery)
        throws HibernateException {
            ...
            if (column == null) {
                throw new HibernateException("PropertyBetweenExpression may only be used with single-column properties");
            }
