...
public class MaxExpression implements Criterion {
    ...
    public MaxExpression(String propertyName, String referencePropertyName, String tableName, Expression... expressions) {
    ...
    public MaxExpression(String propertyName, String referencePropertyName, String tableName, String sqlString) {
        this.propertyName = propertyName;
        this.referencePropertyName = referencePropertyName;
